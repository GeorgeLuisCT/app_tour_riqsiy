  ...
  void loadScene(String sceneName) {
    if (_unityWidgetController != null) {
      _unityWidgetController?.postMessage(
        'GameObjectName', // nombre de tu GameObject que escucha el mensaje en Unity
        'LoadScene', // Método en Unity que se encarga de cargar la escena
        sceneName, // Nombre de la escena que se desea cargar
      );
    } else {
      print("Unity Widget Controller is not initialized."); // Mensaje de error si el controlador no está listo
    }
  }
